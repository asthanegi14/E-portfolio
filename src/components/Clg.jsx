        ...
        <div name='clg' className='pt-20 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 text-black'>
                    ...
                    <div className='w-full grid grid-cols-1 sm:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0'>
                        <Fade distance="20%" duration="2000" bottom>
                            <div className='py-2 rounded-lg '>
                                ...
                                <p onClick={() => { popUp() }} className='hover:scale-105 duration-500 bg-gradient-to-r from-blue-700 via-blue-400 to-blue-600 text-black text-center rounded-md shadow-md mt-4 px-4 py-4 shadow-cyan-900 font-signature'>Weekly Lectures</p>
                            </div>
                        </Fade>
                        <Fade distance="20%" duration="2000" bottom>
                            <div className='py-2 rounded-lg '>
                                <img src={Asign} alt="html" className='object-cover w-full h-48' />
                                <p onClick={() => { popUp2() }} className='hover:scale-105 duration-500 bg-gradient-to-r from-blue-700 via-blue-400 to-blue-600 text-black text-center rounded-md shadow-md mt-4 px-4 py-4 shadow-blue-900 font-signature'>Assignments</p>
                            </div>
                        </Fade>
                        <Fade distance="20%" duration="2000" bottom>
                            <div className='py-2 rounded-lg '>
                                <img src={Interview} alt="html" className='object-cover w-full h-48' />
                                <p onClick={() => { popUp3() }} className='hover:scale-105 duration-500 bg-gradient-to-r from-blue-700 via-blue-400 to-blue-600 text-black text-center rounded-md shadow-md mt-4 px-4 py-4 shadow-blue-900 font-signature'>Personal Interview</p>
                            </div>
                        </Fade>
                        <Fade distance="20%" duration="2000" bottom>
                            <div className='py-2 rounded-lg '>
                                <img src={Gd} alt="html" className='object-cover w-full h-48' />
                                <p onClick={() => { popUp4() }} className='hover:scale-105 duration-500 bg-gradient-to-r from-blue-700 via-blue-400 to-blue-600 text-black text-center rounded-md shadow-md mt-4 px-4 py-4 shadow-blue-900 font-signature'>Group Discussion</p>
                            </div>
                        </Fade>
                    </div>
                </div>
            ...
            <Zoom distance="20%" duration="2000">
                {view1 &&
                    ...
                    <div className='pop top-0 left-0 right-0 bottom-0 fixed  bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600 text-black px-12 py-8'>
